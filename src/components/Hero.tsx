        ...
        <div className="pt-6 pb-24  bg-blue-950">
            <div className="container mx-auto flex flex-wrap-reverse justify-between items-center">
                <div className="w-full md:w-1/2 flex gap-10 flex-col">
                    ...
                    <p className="text-base sm:text-xl md:text-2xl text-white w-full md:w-4/5 text-center md:text-left">Online loan application system braught to you to reduce the time you spend applying form loans, filling paper works, and more</p>
                    <button className="rounded-lg text-black bg-yellow-500 py-2 px-4 w-full md:w-fit flex items-center gap-4">
