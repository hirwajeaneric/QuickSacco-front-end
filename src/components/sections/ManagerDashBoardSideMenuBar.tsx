                    ...
                    <div className="">
                        <div className="px-2">
                            ...
                            <ul className="space-y-1 pt-4">
                                ...
                                <li>
                                    <Link to="/manager/applicants" className="group relative flex justify-center rounded px-2 py-1.5 text-slate-200 hover:bg-gray-50 hover:text-gray-700">
                                        <Users size={18} />
                                        <span className="invisible absolute start-full top-1/2 ms-4 -translate-y-1/2 rounded bg-gray-900 px-2 py-1.5 text-xs font-medium text-white group-hover:visible">
                                            Applicants
                                        </span>
                ...
                <div className={`hidden md:flex min-h-screen flex-1 flex-col justify-between border-e bg-blue-950 cursor-pointer`}>
                    <div className="px-4 py-4">
                        ...
                        <ul className="mt-6 space-y-1">
                            ...
                            <li>
                                <Link to="/manager/applicants" className="block rounded-lg px-4 py-2 text-sm font-medium text-slate-200 hover:bg-gray-100 hover:text-gray-700">
                                    Applicants
                                </Link>
                            </li>
