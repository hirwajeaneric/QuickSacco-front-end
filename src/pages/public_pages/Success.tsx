  ...
  return (
    <div className="flex w-full flex-wrap items-center justify-center">
      <div className="flex flex-col justify-center items-center w-full gap-4">
        ...
        <Link className="rounded px-3 py-2 text-black border-2 border-black bg-transparent hover:bg-slate-700 hover:text-white" to={'/account/applications'}>View your applications</Link>
      </div>
    </div>
  )
}
